...
XLSX_PATH = "results_PC-SC_PC-EC_10tests_8metrics_4x2_spikes/summary_metrics_mean_std.xlsx"
SHEET_NAME = 0
...
def plot_ijbc_4x2(df_ms, metrics, out_dir):
    ...
    for signal_name in sorted(df_ms["signal"].dropna().unique()):
        ...
        for ax, panel_label, (metric, ylabel, ylim01) in zip(axes, panel_labels, metrics):
            ...
            # For error/time/spike-rate plots, start from zero when appropriate
            # if not ylim01:
